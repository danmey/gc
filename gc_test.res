...
Running test 06
**List of minor heap allocated 4 chunks
	chunk 0000	size 008	marked n
	chunk 0001	size 008	marked n
	chunk 0002	size 008	marked n
	chunk 0003	size 008	marked n
**End of minor chunks list
...
**End of stored ref list
**List of stored references. 1 references.
	Reference pointing to 00000000(minor)	
**End of stored ref list
**List of stored references. 3 references.
	Reference pointing to 00000000(minor)	
	Reference pointing to 0a0dc460(??)	
	Reference pointing to 0000fffc(minor)	
**End of stored ref list
**List of stored references. 3 references.
	Reference pointing to 00000000(minor)	
	Reference pointing to 0a0dc460(??)	
	Reference pointing to 0000fffc(minor)	
**End of stored ref list
**List of stored references. 4 references.
	Reference pointing to 00000000(minor)	
	Reference pointing to 0a0dc460(??)	
	Reference pointing to 0000fffc(minor)	
	Reference pointing to 0000fff8(minor)	
**End of stored ref list
**List of stored references. 4 references.
	Reference pointing to 00000000(minor)	
	Reference pointing to 0a0dc460(??)	
...
**List of stored references. 4 references.
	...
	Reference pointing to 0000fff8(minor)	
**End of stored ref list
**List of stored references. 5 references.
	Reference pointing to 00000000(minor)	
	Reference pointing to 0a0dc460(??)	
	Reference pointing to 0000fffc(minor)	
	Reference pointing to 0000fff8(minor)	
...
**Printing referenced major heap offsets
	...
	1	4
**List of major heap allocated chunks
	size 012	marked white
	size 012	marked white
	size 33554408	marked free
**End of major chunks list
Test 11 completed
Running test 12
**List of minor heap allocated 1 chunks
	chunk 0000	size 008	marked n
**End of minor chunks list
**List of major heap allocated chunks
	size 008	marked white
...
Running test 13
**List of major heap allocated chunks
	size 104	marked grey
	size 104	marked white
	size 104	marked grey
	size 33554120	marked free
**End of major chunks list
Test 13 completed
Running test 14
**List of major heap allocated chunks
	size 104	marked black
	size 104	marked black
	size 104	marked black
	size 104	marked black
	size 104	marked white
	size 104	marked white
	size 33553808	marked free
**End of major chunks list
Test 14 completed
